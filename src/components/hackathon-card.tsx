    ...
    <li className="material-small relative flex flex-col gap-3 p-6 leading-5 hover:border-border border border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 group">
      ...
      <div className="flex flex-row items-center gap-4">
        <div className="relative z-10 h-10 w-10 shrink-0">
          <div className="relative inline-flex h-10 w-10 bg-muted/50 rounded-lg border border-border/20 overflow-hidden">
            <img
              src={favicon}
              alt={`${title} favicon`}
        ...
        <div className="flex min-w-0 flex-1 flex-col justify-between gap-1 overflow-hidden">
          <span className="relative z-10 min-w-0 font-medium text-foreground truncate transition-colors duration-300 block">
            {title}
          </span>
          <div className="min-w-0 flex items-center gap-1 overflow-hidden">
            <span className="relative z-10 min-w-0 text-muted-foreground group-hover:text-foreground transition-colors duration-300 text-xs truncate flex-shrink">
      ...
      <div className="flex min-w-0 flex-col justify-between gap-2">
        ...
        <div className="flex flex-row items-center gap-2 flex-wrap">
          <span className="text-xs px-2 py-1 border border-border bg-muted/50 text-muted-foreground font-medium tracking-wide uppercase rounded-sm whitespace-nowrap">
            {status}
          </span>
